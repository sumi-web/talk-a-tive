 ...
 */
users.post('/create', verifyAuthToken, RequestValidator.validate(CreateUserDto), controller.createUser);

users.post('/login', verifyAuthToken, RequestValidator.validate(LogInUserDto), controller.logInUser);
